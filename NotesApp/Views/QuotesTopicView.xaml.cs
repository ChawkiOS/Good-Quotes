...
namespace NotesApp.Views
{
    ...
    /// </summary>
    public sealed partial class QuotesTopicView : Page
    {
        ...
        public QuotesTopicView()
        {
            ...
            DataContext = ViewModel.Statique._QuotesTopicViewModel;
        }

        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            selectedTopic = e.NavigationParameter as DataModel.QuotesTopic;
            pageTitle.Text = selectedTopic.TopicText;
            await Statique._QuotesTopicViewModel.getList(selectedTopic);
        ...
        {
            this.Frame.Navigate(typeof(HubPage), "1");
        }
    }
}
